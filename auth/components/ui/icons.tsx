...
// --- Company Logo (theme-aware: light version in light mode, dark version in dark mode) ---
// Uses a wrapper div so the caller's className (which may include responsive
// visibility like "hidden sm:block") doesn't conflict with the internal
// dark:hidden / dark:block used to switch between light and dark images.
export function CompanyLogo({ className = "w-9 h-9" }: IconProps) {
  return (
    <div className={`${className} overflow-hidden`}>
      <Image
        ...
        width={80}
        height={80}
        className="w-full h-full rounded-lg object-contain block dark:hidden"
        priority
      />
      <Image
        ...
        width={80}
        height={80}
        className="w-full h-full rounded-lg object-contain hidden dark:block"
        priority
      />
    </div>
  );
...
// --- Company Banner (theme-aware: light version in light mode, dark version in dark mode) ---
export function CompanyBanner({ className = "w-full" }: IconProps) {
  return (
    <div className={`${className} overflow-hidden`}>
      <Image
        src="/images/Banner_white.png"
        alt="SerTEC - Gestion Inteligente de Clientes & Colaboradores"
        width={1200}
        height={400}
...
// --- People with plus (used on landing page feature card, slightly different path) ---
export function UsersGroupIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
// --- Clipboard list (without checkmark, landing page feature 2) ---
export function ClipboardListIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
// --- Spinner / Loading ---
export function SpinnerIcon({ className = "animate-spin h-8 w-8" }: IconProps) {
  return (
...
export function WarningIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// --- Info / Help Circle ---
export function InfoCircleIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// --- Admin Users ---
export function AdminUsersIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
