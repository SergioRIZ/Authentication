        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <h1 className="text-2xl font-bold text-foreground flex items-center gap-3">
              <span className="w-9 h-9 bg-section-admin-light border border-section-admin-border rounded-xl flex items-center justify-center">
          ...
          <Link
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-section-admin bg-section-admin-light border border-section-admin-border rounded-xl hover:opacity-80 transition-colors"
          >
